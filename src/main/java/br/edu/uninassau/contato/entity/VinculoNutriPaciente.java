...
public class VinculoNutriPaciente { 
    ...
    public Long getFkIdUser() { return usuario != null ? usuario.getIdUser() : null; } 

    public Long getFkIdNutri() { return nutricionista != null ? nutricionista.getIdNutri() : null; } 

    public String getNutricionistaNome() { return nutricionista != null ? nutricionista.getNomeCompleto() : null; } 

    public String getNutricionistaEspecialidade() { return nutricionista != null ? nutricionista.getEspecialidadePrincipal() : null; } 

    public String getUsuarioNome() { return usuario != null ? usuario.getNomeCompleto() : null; } 
